...
${OBJECTDIR}/AVL.o: AVL.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AVL.o AVL.cpp

${OBJECTDIR}/FuncionesHash.o: FuncionesHash.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FuncionesHash.o FuncionesHash.cpp

${OBJECTDIR}/Graphviz.o: Graphviz.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Graphviz.o Graphviz.cpp

${OBJECTDIR}/ListaTablas.o: ListaTablas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ListaTablas.o ListaTablas.cpp
...
${OBJECTDIR}/OperacionesInsercion.o: OperacionesInsercion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OperacionesInsercion.o OperacionesInsercion.cpp

${OBJECTDIR}/OperacionesSeleccion.o: OperacionesSeleccion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OperacionesSeleccion.o OperacionesSeleccion.cpp

${OBJECTDIR}/OrdenamientoSeleccion.o: OrdenamientoSeleccion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OrdenamientoSeleccion.o OrdenamientoSeleccion.cpp

${OBJECTDIR}/ReposicionamientoNodos.o: ReposicionamientoNodos.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReposicionamientoNodos.o ReposicionamientoNodos.cpp

${OBJECTDIR}/SeparacionPalabras.o: SeparacionPalabras.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SeparacionPalabras.o SeparacionPalabras.cpp
...
${OBJECTDIR}/TextoConsultas.o: TextoConsultas.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TextoConsultas.o TextoConsultas.cpp
